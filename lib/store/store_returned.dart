...
class StoreReturned extends StatefulWidget {
  const StoreReturned({super.key});

  @override
  State<StoreReturned> createState() => _StoreReturnedState();
}

class _StoreReturnedState extends State<StoreReturned> {
  int total = 1;
  @override
