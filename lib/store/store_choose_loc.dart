...
class StoreChooseLocation extends StatefulWidget {
  const StoreChooseLocation({super.key});

  @override
  State<StoreChooseLocation> createState() => _StoreChooseLocationState();
}

class _StoreChooseLocationState extends State<StoreChooseLocation> {
  @override
