...
class RiderReturned extends StatefulWidget {
  const RiderReturned({super.key});

  @override
  State<RiderReturned> createState() => _RiderReturnedState();
}

class _RiderReturnedState extends State<RiderReturned> {
  int total = 1;
  @override
