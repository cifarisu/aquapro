...
class RiderCompleted extends StatefulWidget {
  const RiderCompleted({super.key});

  @override
  State<RiderCompleted> createState() => _RiderCompletedState();
}

class _RiderCompletedState extends State<RiderCompleted> {
  int total = 1;
  @override
